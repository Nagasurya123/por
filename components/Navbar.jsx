  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:block">
        <ul className="flex flex-row gap-2 lg:gap-3 p-3 lg:p-4 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200/50 shadow-sm">
      ...
      <div className="hidden md:block lg:hidden">
        <ul className="flex flex-row gap-2 p-2 bg-white/80 backdrop-blur-sm rounded-lg border border-gray-200/50 shadow-sm flex-wrap justify-end">
          {navigationItems.map((item) => {
            const isActive = activeHash === item.href;
            return (
              <li key={item.name}>
